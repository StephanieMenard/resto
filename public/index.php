<body>
        <!--ICON SOCIAL-->
        <div class="col">
    <div class="btn-group" style="position:absolute; bottom:1%; right:1%;" role="group"
      aria-label="Basic outlined example">
      <button type="button" class="bouton btn">
        <!-- Facebook icon-->
...
require './../data/chef_lorem.php';
require './../data/carrousel-accueil.php';
?>

  <!--IMAGE ACCUEIL-->
  <section class="accueil bg-dark d-flex w-100 h-100 flex-column justify-content-center align-items-center">
    <h1 class="display-1 text-center text-dark"><?= $chef['nomresto']?></h1>
    <p class="lead text-center text-dark">Chef Lorem Ipsum à votre domicile</p>
    <p class="lead mb-5">
      <a href="#chef_lorem" class="bouton btn">En savoir plus</a>
    </p>
  </section>
  ...
  <div class="fond container mt-5 p-5 py-5">
    <h1 id="chef_lorem" class="display-4 text-center mb-5"><?= $chef['nom'] ?></h1>
    <div class="row">
    ...
    <div class="row fond divMenu">
      ...
      <div class="fond itemMenu card mx-3 mb-4 shadow-sm col-8 col-sm-6 col-md-4 col-lg-4 mx-auto">
        ...
        <div class="card-body text-center">
          ...
          <a href="./menu.php?indexMenu=<?= $index ?>" class="bouton post__link btn">Découvrir</a>
        </div>
      </div>
      <?php endforeach ?>
    </div>
  ...
  <div class="fond container mt-5 p-5 py-5">
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <h2 class="display-4 text-center mb-5" id="galerie_photo">Galerie photo</h2>
        <?php foreach ($carrouselAccueil as $image) : ?>
        <div class="carousel-item active">
          <img src="<?= $image['image']?>" class="d-block w-100" style="height:800px;"
            alt="image carrousel">
        </div>
        <?php endforeach ?>
      </div>
